...
#include<string.h>
#include<malloc.h>
/* Defining The Value Of Max */
#define MAXX 1000
/* Function Th Insert Manually */
void insert(void)
{
FILE *p;
...
/* Function To Obtain The Number Of Rows And Columns From The Source Matrix */
int getmax(void)
{
FILE *p;
int c=0;
...
printf("\n\n To View The Segmented Files \n Go To The Same Location Where The .exe File Of The Program Is Saved\n");
printf("\n\n Thank You !\n");
return 0;
}
